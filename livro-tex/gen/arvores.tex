...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Escola Formal de Magia. Conjura com Intelecto (BC = Intelecto + Bônus de Rank).}
\par\smallskip\textbf{Ensina:} Arcanismo --- mais 1 à sua escolha entre Ofícios, Intimidação e Atletismo. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Escola Formal de Magia. Conjura com Intelecto (BC = Intelecto + Bônus de Rank).}
\par\smallskip\textbf{Ensina:} Arcanismo --- mais 1 à sua escolha entre Medicina, Natureza e Percepção. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d4+1}}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Escola Formal de Magia. Conjura com Intelecto (BC = Intelecto + Bônus de Rank).}
\par\smallskip\textbf{Ensina:} Arcanismo --- mais 1 à sua escolha entre Acrobacia, Percepção e Sobrevivência. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Escola Formal de Magia. Conjura com Intelecto (BC = Intelecto + Bônus de Rank).}
\par\smallskip\textbf{Ensina:} Arcanismo --- mais 1 à sua escolha entre Ofícios, Atletismo e Natureza. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Escola Formal de Magia. Conjura com Espírito (Cap. 1, §7).}
\par\smallskip\textbf{Ensina:} Medicina --- mais 1 à sua escolha entre Religião, Intuição e Persuasão. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d4+2}}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Escola Formal de Magia. Conjura com Espírito.}
\par\smallskip\textbf{Ensina:} Medicina --- mais 1 à sua escolha entre Natureza, Ofícios e Investigação. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d6+2}}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Escola Formal de Magia. Conjura com Espírito.}
\par\smallskip\textbf{Ensina:} Arcanismo --- mais 1 à sua escolha entre Religião, Percepção e Intuição. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d6+2}}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Escola Formal de Magia. Conjura com Espírito.}
\par\smallskip\textbf{Ensina:} Arcanismo --- mais 1 à sua escolha entre Natureza, Lidar com Animais e Religião. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d6+2}}
...
\par\medskip\textbf{Armas e armaduras:} Toda espada (curta, longa, espadão, rapieira, katana). NÃO concede armadura média nem pesada --- a doutrina proíbe vesti-las, e vestir desliga a árvore inteira.\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Escola Formal do Corpo. Armadura leve apenas. CA base −2.}
\par\smallskip\textbf{Ensina:} Acrobacia e Intimidação. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Toda espada, mais escudo leve. Proficiência com armadura leve e média ('Peso Não Atrapalha').\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Escola Formal do Corpo.}
\par\smallskip\textbf{Ensina:} Intuição e Percepção. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d8+3} \textbullet\ +1 degrau(s) de Dado de Arma}
...
\par\medskip\textbf{Armas e armaduras:} Ataque desarmado (Dado Base d6), toda arma pesada, de duas mãos e improvisada. Armadura leve, média e pesada.\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Ofício do Corpo (sem patamar Deus).}
\par\smallskip\textbf{Ensina:} Atletismo e Intimidação. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Toda arma de uma mão, TODO escudo, e armadura leve, média e pesada --- o pacote de proficiência mais completo do livro em defesa.\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Ofício do Corpo (sem patamar Deus).}
\par\smallskip\textbf{Ensina:} Atletismo e Percepção. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Toda espada e toda arma de haste. Armadura leve apenas --- o estilo inteiro depende de deslocamento.\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Árvore híbrida do Corpo --- exige Avançado em Deus do Norte E em Magia de Vento.}
\par\smallskip\textbf{Ensina:} Acrobacia e Percepção. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d8+2} \textbullet\ +1 degrau(s) de Dado de Arma}
...
\par\medskip\textbf{Armas e armaduras:} Arco curto, arco longo, besta e funda. Armadura leve apenas --- puxar corda com peitoral de placas não funciona.\par\textbf{Perícias:} O Bônus de Rank desta árvore NÃO soma em perícia nenhuma --- somar em perícia é exclusivo das três árvores de Utilidade (Cap. 3).\par\smallskip{\itshape Ofício do Corpo (sem patamar Deus).}
\par\smallskip\textbf{Ensina:} Percepção e Sobrevivência. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Adaga, punhal, espada curta, funda e besta leve. Armadura leve apenas.\par\textbf{Perícias:} O Bônus de Rank soma em Furtividade, Ladinagem, Percepção, Acrobacia e Enganação (disfarce) --- mas só nas que você realmente possui (Cap. 3).\par\smallskip{\itshape Ofício de Utilidade --- gasta PP, nunca PT, e nunca recebe Touki.}
\par\smallskip\textbf{Ensina:} Furtividade e Percepção --- mais 1 à sua escolha entre Ladinagem, Acrobacia e Enganação. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA. \textbf{Exceção única do livro: se esta NÃO for a sua Árvore Inicial, a Maestria de 1º patamar ainda ensina Furtividade e Percepção.}
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Adaga, espada curta e rapieira, mais todo instrumento musical. Armadura leve apenas.\par\textbf{Perícias:} O Bônus de Rank soma em Atuação, Persuasão, Intuição e História --- mas só nas que você realmente possui (Cap. 3).\par\smallskip{\itshape Ofício de Utilidade --- gasta PP, nunca PT, e nunca recebe Touki.}
\par\smallskip\textbf{Ensina:} Atuação e Persuasão --- mais 1 à sua escolha entre Intuição e História. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Armas simples, arco curto e lança. Armadura leve e média.\par\textbf{Perícias:} O Bônus de Rank soma em Sobrevivência, Natureza, Investigação e Percepção (rastreio) --- mas só nas que você realmente possui (Cap. 3).\par\smallskip{\itshape Ofício de Utilidade --- gasta PP, nunca PT, e nunca recebe Touki.}
\par\smallskip\textbf{Ensina:} Sobrevivência e Investigação --- mais 1 à sua escolha entre Natureza e Percepção. Você só recebe estas perícias se esta for a sua Árvore Inicial --- a primeira que você abriu; elas entram na ficha sozinhas, sem gastar PA.
\end{arvorecard}
