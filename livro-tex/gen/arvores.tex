...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} Arcanismo é a perícia da escola; o Bônus de Rank NÃO soma em perícia nenhuma (isso é exclusivo da Utilidade).\par\smallskip{\itshape Escola Formal de Magia. Conjura com Intelecto (BC = Intelecto + Bônus de Rank).}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Arcanismo, mais 1 à escolha entre Ofícios, Intimidação, Atletismo.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} Arcanismo é a perícia da escola; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Escola Formal de Magia. Conjura com Intelecto (BC = Intelecto + Bônus de Rank).}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Arcanismo, mais 1 à escolha entre Medicina, Natureza, Percepção.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d4+1}}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} Arcanismo é a perícia da escola; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Escola Formal de Magia. Conjura com Intelecto (BC = Intelecto + Bônus de Rank).}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Arcanismo, mais 1 à escolha entre Acrobacia, Percepção, Sobrevivência.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} Arcanismo e Ofícios (construção) são as perícias da escola; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Escola Formal de Magia. Conjura com Intelecto (BC = Intelecto + Bônus de Rank).}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Arcanismo, mais 1 à escolha entre Ofícios, Atletismo, Natureza.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} Medicina é a perícia da escola; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Escola Formal de Magia. Conjura com Espírito (Cap. 1, §7).}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Medicina, mais 1 à escolha entre Religião, Intuição, Persuasão.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d4+2}}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} Medicina e Ofícios (Alquimia) são as perícias da escola; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Escola Formal de Magia. Conjura com Espírito.}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Medicina, mais 1 à escolha entre Natureza, Ofícios, Investigação.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d6+2}}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} Arcanismo é a perícia da escola; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Escola Formal de Magia. Conjura com Espírito.}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Arcanismo, mais 1 à escolha entre Religião, Percepção, Intuição.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d6+2}}
...
\par\medskip\textbf{Armas e armaduras:} Nenhuma além do padrão (armas simples, armadura leve).\par\textbf{Perícias:} Arcanismo e Natureza são as perícias da escola; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Escola Formal de Magia. Conjura com Espírito.}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Arcanismo, mais 1 à escolha entre Natureza, Lidar com Animais, Religião.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d6+2}}
...
\par\medskip\textbf{Armas e armaduras:} Toda espada (curta, longa, espadão, rapieira, katana). NÃO concede armadura média nem pesada --- a doutrina proíbe vesti-las, e vestir desliga a árvore inteira.\par\textbf{Perícias:} Acrobacia e Intimidação são as perícias do estilo; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Escola Formal do Corpo. Armadura leve apenas. CA base −2.}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Acrobacia, Intimidação.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Toda espada, mais escudo leve. Proficiência com armadura leve e média ('Peso Não Atrapalha').\par\textbf{Perícias:} Intuição e Percepção são as perícias do estilo; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Escola Formal do Corpo.}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Intuição, Percepção.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d8+3} \textbullet\ +1 degrau(s) de Dado de Arma}
...
\par\medskip\textbf{Armas e armaduras:} Ataque desarmado (Dado Base d6), toda arma pesada, de duas mãos e improvisada. Armadura leve, média e pesada.\par\textbf{Perícias:} Atletismo e Intimidação são as perícias do ofício; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Ofício do Corpo (sem patamar Deus).}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Atletismo, Intimidação.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Toda arma de uma mão, TODO escudo, e armadura leve, média e pesada --- o pacote de proficiência mais completo do livro em defesa.\par\textbf{Perícias:} Atletismo e Percepção são as perícias do ofício; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Ofício do Corpo (sem patamar Deus).}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Atletismo, Percepção.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Toda espada e toda arma de haste. Armadura leve apenas --- o estilo inteiro depende de deslocamento.\par\textbf{Perícias:} Acrobacia e Percepção são as perícias do estilo; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Árvore híbrida do Corpo --- exige Avançado em Deus do Norte E em Magia de Vento.}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Acrobacia, Percepção.
\end{arvorecard}
\patamar{Principiante}{Dado de PV \dado{1d8+2} \textbullet\ +1 degrau(s) de Dado de Arma}
...
\par\medskip\textbf{Armas e armaduras:} Arco curto, arco longo, besta e funda. Armadura leve apenas --- puxar corda com peitoral de placas não funciona.\par\textbf{Perícias:} Percepção e Sobrevivência são as perícias do ofício; o Bônus de Rank NÃO soma em perícia nenhuma.\par\smallskip{\itshape Ofício do Corpo (sem patamar Deus).}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Percepção, Sobrevivência.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Adaga, punhal, espada curta, funda e besta leve. Armadura leve apenas.\par\textbf{Perícias:} O Bônus de Rank soma em Furtividade, Ladinagem, Percepção, Acrobacia e Enganação (disfarce). Como Árvore Inicial, ensina Furtividade e Percepção mais uma à escolha entre Ladinagem, Acrobacia e Enganação. Se NÃO for a sua Árvore Inicial, a Maestria de 1º patamar ainda ensina Furtividade e Percepção --- exceção única do livro.\par\smallskip{\itshape Ofício de Utilidade --- gasta PP, nunca PT, e nunca recebe Touki.}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Furtividade, Percepção, mais 1 à escolha entre Ladinagem, Acrobacia, Enganação. \textbf{Exceção:} a Maestria de 1º patamar ensina Furtividade e Percepção mesmo a quem chegou depois.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Adaga, espada curta e rapieira, mais todo instrumento musical. Armadura leve apenas.\par\textbf{Perícias:} O Bônus de Rank soma em Atuação, Persuasão, Intuição e História, e em mais nada (Cap. 3).\par\smallskip{\itshape Ofício de Utilidade --- gasta PP, nunca PT, e nunca recebe Touki.}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Atuação, Persuasão, mais 1 à escolha entre Intuição, História.
\end{arvorecard}
...
\par\medskip\textbf{Armas e armaduras:} Armas simples, arco curto e lança. Armadura leve e média.\par\textbf{Perícias:} O Bônus de Rank soma em Sobrevivência, Natureza, Investigação e Percepção (rastreio), e em mais nada (Cap. 3).\par\smallskip{\itshape Ofício de Utilidade --- gasta PP, nunca PT, e nunca recebe Touki.}
\par\smallskip\textbf{Ensina (só como Árvore Inicial):} Sobrevivência, Investigação, mais 1 à escolha entre Natureza, Percepção.
\end{arvorecard}
