...
const MEDICAO = String.raw`(() => {
  ...
  function nomeAcessivel(el) {
    ...
    // todas as dezessete rotas por um defeito que não existe.
...
console.log("\n✅ Nenhum problema estrutural nas dezessete rotas. (Teste com leitor de tela de verdade continua pendente.)");
