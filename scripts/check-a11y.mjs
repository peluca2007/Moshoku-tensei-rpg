...
const ROTAS = ["/", "/mesa", "/ficha", "/arvores", "/personagens", "/iniciativa", "/encontros", "/mestre", "/comparar", "/loja", "/livro", "/busca?q=fogo", "/criar", "/offline", "/rota-que-nao-existe", "/ficha/importar#g:linkCortadoDeProposito"];
...
const MEDICAO = String.raw`(() => {
  ...
  function nomeAcessivel(el) {
    ...
    // todas as dezesseis rotas por um defeito que não existe.
...
console.log("\n✅ Nenhum problema estrutural nas dezesseis rotas. (Teste com leitor de tela de verdade continua pendente.)");
