...
const MEDICAO = String.raw`(() => {
  ...
  function nomeAcessivel(el) {
    ...
    // todas as rotas da lista por um defeito que não existe.
...
console.log(`\n✅ Nenhum problema estrutural nas ${ROTAS.length} rotas. (Teste com leitor de tela de verdade continua pendente.)`);
