...
export const SIMPLIFICACOES = [
  ...
  "O que de suporte segue de fora: Salvações e os circuitos espaciais da Magia Teórica — fronteiras, selos, ligações e gatilhos dependem de posição e suporte, e este motor não tem mapa. Julgamento e Luz Absoluta entram como as magias de DANO que são; a cura secundária que as duas descrevem na prosa não é contada.",
