  ...
  return (
    <div className="mx-auto max-w-6xl p-4 sm:p-6">
      <header className="mb-6 flex flex-wrap items-center justify-between gap-3">
        ...
        <span className="flex items-center gap-1 rounded-full bg-violet-500/10 px-3 py-1 text-sm font-medium text-violet-600 ring-1 ring-violet-500/30 dark:text-violet-400">
          <Gem className="h-4 w-4" /> {paRemaining} PA disponíveis
        </span>
      </header>
