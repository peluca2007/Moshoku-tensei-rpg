    ...
    <div className="space-y-8">
      ...
      <Section>
        ...
        <Warning title="Uma criatura do patamar do grupo por jogador">
          ...
          <P>
            <b>As quatro temperaturas</b> (o peso do encontro dividido pelo orçamento): até <b>0,75</b> é{" "}
            <i>fácil</i>, de gastar munição e mostrar o bicho; até <b>1,25</b>, <i>equilibrado</i>; até{" "}
            <b>1,5</b>, <i>difícil</i> — alguém termina com pouca vida; acima disso, <i>mortal</i>: alguém
            vai ao Fio da Vida. Reserve o mortal para o fim do arco e avise a mesa — o Perigo do contrato
            (seção da Guilda, Cap. 5) existe exatamente para isso.
          </P>
          <P>
