    ...
    },
    {
      ...
      talents: [
        ...
        { id: "evolucao-forma-imortal",
          requires: ["evolucao-forma-media"], name: "Evolução: Forma Suprema", paCost: RANK_PA_COST.talent.Avançado, description: "Requer Evolução: Forma Média. Seu filhote atinge o auge (Grande ou Voador): 4d8 de dano elementar ou físico, PV = 25 × seu Bônus de Rank e Resistência a dano físico. E ELE APRENDE A CONJURAR: escolha UMA escola de magia que não seja esta (Fogo, Água, Vento, Terra, Cura, Barreira ou Desintoxicação) e gaste 2 PA do BICHO no 1º patamar dela, pelas tabelas do Cap. 1, §3 — duas magias comuns, ou uma comum e um talento, ou uma Assinatura ◆. Esses 2 PA são dele, não saem do seu bolso, e você não precisa ter aquela escola: o fogo é dele, não seu. Ele conjura com o SEU BC, gasta o SEU PM, e sai em 1 Ação, sem cântico, com a penalidade do Encantamento Encurtado (metade do dano; área reduzida em um terço) — uma fera não recita, ela cospe. A partir daqui ele conta como Pacto de Avançado para invocar (9 PM)." },
