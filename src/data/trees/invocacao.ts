  ...
  ranks: [
      ...
      abilities: [
        {
          ...
          actions: { normal: 1 },
          effect:
            "Invoca uma criatura com quem você tenha Pacto. Ela surge no círculo e age a partir do próximo turno. Desenhar o círculo custa 10 minutos fora de combate, ou 1 Ação e o dobro do PM no meio da luta.",
    ...
    },
    {
      ...
      talents: [
        ...
        { id: "vontade-firme", name: "Vontade Firme", paCost: RANK_PA_COST.talent.Intermediário, description: "Invocados seus são imunes a Amedrontado e não podem ser dominados, expulsos ou dissipados por efeito de patamar inferior ao seu." },
    ...
    },
    {
      ...
      talents: [
        { id: "pacto-quimera", name: "Pacto: Quimera", paCost: RANK_PA_COST.talent.Avançado, description: "Três cabeças, três ataques por turno de 4d8 cada, um deles com sopro elemental à sua escolha ao invocar." },
        ...
        { id: "pacto-alcateia", name: "Pacto: Alcateia", paCost: RANK_PA_COST.talent.Avançado, description: "Invoca cinco lobos de uma vez, cada um com um quarto dos PV normais, agindo na mesma Iniciativa." },
