...
export const ESCUDOS_TREE: Tree = {
  ...
  proficiencies: {
    armas: "Grupos Espadas, Lâminas Curtas, Machados e Marretas, Hastes e Escudos — toda arma que se empunha numa mão só, mais o escudo. Armadura leve, média e pesada: o pacote de defesa mais completo do livro.",
