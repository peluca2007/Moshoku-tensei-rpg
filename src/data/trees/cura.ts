...
export const CURA_TREE: Tree = {
  ...
  mechanic: {
    ...
    cost:
      "Não trata veneno, doença, maldição nem petrificação, em rank nenhum — isso é Desintoxicação, e a separação é absoluta. E a luz que fere é a metade fraca da escola: até o Rei, o dobro da Ferida Fresca só vale pra curar.",
  },
  ...
  ranks: [
      ...
      abilities: [
        {
          ...
          damage: { normal: "1d8 + BC de PV, sempre como Ferida Fresca: 2d8 + BC" },
          effect: "1 Reação, quando um aliado visível sofrer dano. A magia que define a escola — cura enquanto o golpe ainda está acontecendo. Pela Luz de Dois Gumes, ela pode queimar quem deu o golpe em vez de curar, se ele estiver a 9 metros.",
        ...
        },
        {
          ...
          damage: { normal: "1d4 + BC de PV (2d4 + BC para quem tiver Ferida Fresca)" },
      ...
      abilities: [
        {
          ...
          damage: { normal: "3d8 + BC de PV (6d8 + BC se Ferida Fresca)" },
        ...
        },
        {
          ...
          actions: { normal: 1 },
          costNote:
            "4 PA em vez dos 2 do Avançado comum. É uma das Salvações do livro (Cap. 4, §5) — impede uma morte de verdade, não recupera PV numérico. Vale mais que qualquer magia de dano do mesmo rank porque a alternativa dela não é 'menos eficiente', é a ficha do aliado terminando ali.",
      ...
      abilities: [
        {
          ...
          damage: { normal: "5d8 + BC de PV (10d8 + BC se Ferida Fresca)" },
    ...
    },
    {
      ...
      abilities: [
        {
          id: "a-noite-de-uma-hora",
          name: "A Noite de Uma Hora",
          ...
          ritual: true,
          costNote:
            "GRANDE OBRA — 6 Ações e Ritual (Cap. 2, §3). É a segunda respiração do grupo inteiro no meio de uma luta perdida, e o preço é o curandeiro passar dois turnos sem curar ninguém enquanto os outros seguram a linha. Se alguém te acertar antes da última palavra, os 26 PM vão embora e a luta continua exatamente como estava.",
          effect:
            "Uma vez por Descanso Longo. Cada aliado na área que possa te ouvir recupera TODOS os PT e PP, PM iguais ao dobro do seu Bônus de Rank em Cura, e PV iguais ao Vigor dele mais o seu Bônus de Rank. Não alcança quem está no Fio da Vida: esta magia devolve fôlego, não vida. Não remove Trauma, Cicatriz nem Exaustão — a noite passa, o corpo não esquece.",
          incantation:
            "Vocês não dormiram. Eu sei. Ninguém aqui dormiu desde que isto começou, e não vai dar tempo de dormir depois.\nEntão eu tomo emprestada uma noite inteira de algum lugar onde ela não estava fazendo falta nenhuma a ninguém,\ndobro essa noite até ela caber dentro de uma hora, e ponho essa hora em cima de vocês sem pedir licença ao relógio.\nRespirem. É só isso que eu estou oferecendo, e é tudo que ainda dá pra oferecer daqui.\nA Noite de Uma Hora!",
        },
        {
          id: "restauracao",
          name: "Restauração",
        ...
        },
        {
          ...
          range: "Esfera de 12m",
          actions: MAGIC_ACTIONS.Rei,
          damage: { normal: "10d8 + BC de dano radiante em cada criatura hostil (Vigor para metade; mortos-vivos, construtos e corrompidos não testam)" },
          healing: { normal: "3d4 + BC" },
          effect: "Criaturas hostis na área sofrem o dano; aliados vivos recuperam 3d4 + BC de PV na mesma conjuração (dados dobrados para quem tiver Ferida Fresca).",
          incantation:
        ...
        },
        {
          ...
          range: "Toque",
          actions: MAGIC_ACTIONS.Rei,
          effect: "Remove uma condição de qualquer origem, inclusive Paralisado, Congelado, Amedrontado mágico e cegueira mágica. Exceção absoluta: veneno, doença, maldição e petrificação continuam fora de alcance.",
          incantation:
    ...
    },
    {
      ...
      mastery: {
        ...
        description:
          "Você regenera membros perdidos independentemente de quanto tempo faz e sem precisar dos ossos. Contra Ferida Fresca, suas magias de Cura curam o valor máximo dos dados já dobrados, sem rolar. Uma vez por turno, conjure magia de Cura de rank Avançado ou inferior em Silenciosa sem gastar Ação.",
      },
      talents: [
      ...
      abilities: [
        ...
        },
        {
          id: "santuario",
          costNote:
            "Só a versão normal, de 4 Ações: sem Encurtada e sem Silenciosa. É a maior magia de Salvação em ÁREA do livro, e ela não sai às pressas nem calada. O preço está na trava: enquanto ele estiver ativo você não conjura mais nada, então o curandeiro troca a rodada inteira dele pela sobrevivência de todo mundo.",
          name: "Santuário",
          ritual: true,
          ...
          actions: { normal: 4 },
          effect:
            "Ritual (4 Ações). 1 minuto: nenhuma criatura viva na área pode morrer — ainda caem a 0 PV, mas não recebem Marcas da Morte e não podem ser mortas por efeito abaixo de rank Deus. Cada criatura que ele impedir de morrer consome uma das duas Salvações dela naquele combate (Cap. 4, §5); quem já gastou as duas não é protegido por ele. Quando acaba, todo o dano acumulado é aplicado de uma vez, e quem estiver a 0 PV começa o Teste do Fio da Vida normalmente. Você não pode conjurar outra magia enquanto ativo.",
          incantation:
