...
export const ARQUEARIA_TREE: Tree = {
  ...
  proficiencies: {
    armas: "Grupos Arcos e Bestas, e Arremesso. Armadura leve apenas — puxar corda com peitoral de placas não funciona.",
      ...
      abilities: [
        {
          ...
          effect:
            "Preparação em quatro etapas, 1 Ação cada, na ordem. Cada uma pede um teste CD 12; FALHAR NÃO INTERROMPE — você só perde o bônus daquela etapa. Sofrer dano exige teste de Concentração (Cap. 4, §3) ou a Preparação se perde. (1) A Corda, Força: +2 degraus no Dado de Arma deste disparo. (2) Os Dedos, Agilidade: +1 degrau no Dado de Arma, e o disparo ignora Cobertura. (3) A Leitura, teste de INTUIÇÃO — ou, se você não tem a perícia, Intelecto ou Espírito puro (o maior): o alvo não soma Agilidade na CA contra este tiro — você atirou onde ele ia estar. A Solta continua sendo um teste de ataque como qualquer outro: nenhuma etapa garante o acerto. (4) A Solta: o teste de ataque normal. Opcionalmente, gaste 1 Ação a mais antes da Solta — O Ponto: Medicina contra humanoide, Sobrevivência contra fera ou monstro, CD 12; o disparo passa a critar em 19-20 e ignora Resistência a dano.",
        },
        {
          id: "disparo-duplo",
          name: "Disparo Duplo",
