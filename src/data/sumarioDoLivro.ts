...
export const SUMARIO_DO_LIVRO: TocEntry[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "cap2-3-pm", label: "— PM de referência por rank" },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "cap4-manobras", label: "— Empurrar, Derrubar e Desarmar" },
      { id: "cap4-movimento", label: "— Alcance, Queda, Voo e Montaria" },
      { id: "cap4-cobertura", label: "— Cobertura e Linha de Visão" },
      ...
      { id: "cap4-dano", label: "— Tipos de Dano" },
