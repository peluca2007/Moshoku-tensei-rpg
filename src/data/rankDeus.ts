...
const RANK_DEUS: Record<string, RankDeusEntry> = {
  ...
  "punho-de-fogo": {
    ...
    body: [
      "Todo o Punho de Fogo é um ciclo com teto: você bate para acumular Calor, o Calor para em 5 por patamar, e todo turno sem acertar ninguém tira um ponto da barra. O patamar Divino quebra as três coisas de uma vez. O Calor deixa de ter teto e deixa de precisar de alvo — ele sobe porque o corpo está vivo, e continua subindo enquanto estiver.",
