...
#show heading: it => block(width: 100%, above: 1.1em, below: 0.55em)[#it]
...
#show heading.where(level: 3): it => text(size: 12.5pt, fill: sepia, weight: "bold")[#it.body]
#show heading.where(level: 4): it => text(size: 10.8pt, fill: sepia, weight: "bold", style: "italic")[#it.body]

#set table(stroke: none)
#show table.cell.where(y: 0): set text(weight: "bold", fill: creme)

// --- quadro de regra (os antigos blockquotes do Homebrewery) ---
#let quadro(titulo: none, corpo) = block(
  width: 100%, fill: bloco-bg, inset: (x: 8pt, y: 7pt), radius: 2pt,
  stroke: (left: 2.5pt + sepia), breakable: true, above: 0.9em, below: 0.9em,
)[
  #if titulo != none {
...
// --- tabela do livro ---
#let tbl(cols, alinhas, ..celulas) = block(width: 100%, above: 0.8em, below: 0.9em)[
  #set text(size: 8.8pt)
  #table(
    columns: cols,
    align: alinhas,
...
#largo[
#tbl(3, (left, left, left),
  [Subgrupo da Árvore Inicial], [Árvores], [Kit Inicial],
  [Espadachim], [Deus da Espada, Deus do Norte, Deus da Água], [Uma espada longa ou curta, com bainha. Suishin-ryū soma um escudo e armadura leve; os outros dois, roupas de viagem resistentes.],
  [Guerreiro / Parrudice], [Lutador], [Uma arma pesada à escolha (machado, martelo ou montante) — ou nenhuma, se preferir lutar com as próprias mãos desde o 1º patamar.],
  [Tank / Defensor], [Cavalaria e Escudos], [Um escudo, uma arma de uma mão e armadura média.],
  [Arqueiro], [Arquearia], [Um arco curto, 20 flechas e uma adaga reserva.],
  [Magia Ofensiva], [Água, Fogo, Vento, Terra], [Um cajado ou foco arcano (conta como objeto improvisado corpo a corpo), um grimório básico e roupas de viajante.],
  [Cura e Suporte], [Cura, Desintoxicação, Barreira], [Um kit de cura (bandagens, ervas, um frasco vazio), um símbolo do templo de origem e um cajado leve.],
  [Invocação], [Invocação], [Giz e tinta ritual pra três círculos e uma adaga.],
  [Batedor e Ladrão], [Furtividade e Armadilhas], [Duas adagas, um kit de arrombamento e roupas escuras.],
  [Bardo], [Bardo e Interação], [Um instrumento musical à escolha e uma adaga.],
  [Sobrevivência e Táticas], [Navegação e Liderança], [Um kit de sobrevivência (corda, mapa em branco, uma semana de provisões) e uma arma simples à escolha.],
)
]
...
*Talentos Principiantes* — _1 PA cada_
...
*Talentos Intermediários* — _1 PA cada_
...
*Talentos Avançados* — _2 PA cada_
...
*Talentos Franco-Atirador* — _2 PA cada_
...
*Talentos Olho de Águia* — _2 PA cada_
...
*Talento Lenda da Flecha* — _4 PA_
...
*Técnicas Briguente* — _1 PA cada (◆ 2 PA)_
...
*Talentos Briguente* — _1 PA cada_
...
*Técnicas Combatente* — _1 PA cada (◆ 2 PA)_
...
*Talentos Combatente* — _1 PA cada_
...
*Técnicas Veterano* — _2 PA cada (◆ 3 PA)_
...
*Técnicas Campeão* — _3 PA cada (◆ 4 PA)_
...
*Técnicas Mestre de Guerra* — _3 PA cada (◆ 5 PA)_
...
*Técnicas Lenda Viva* — _4 PA cada (◆ 6 PA)_
...
*Técnicas Escudeiro* — _1 PA cada (◆ 2 PA)_
...
*Talentos Escudeiro* — _1 PA cada_
...
*Técnicas Guarda* — _1 PA cada (◆ 2 PA)_
...
*Técnicas Protetor* — _2 PA cada (◆ 3 PA)_
...
*Técnicas Guardião* — _3 PA cada (◆ 4 PA)_
...
*Técnicas Muralha* — _3 PA cada (◆ 5 PA)_
...
*Técnicas Bastião* — _4 PA cada (◆ 6 PA)_
...
*Talentos Especialista* — _2 PA cada_
...
*Talentos Mestre Espião* — _2 PA cada_
...
*Talentos Lenda Oculta* — _3 PA cada_
...
*Talentos Voz do Mundo* — _3 PA cada_
...
*Talentos Explorador* — _1 PA cada_
...
*Talentos Rastreador* — _1 PA cada_
...
*Talentos Estrategista* — _2 PA cada_
...
*Talentos Comandante* — _3 PA cada_
...
*Talentos Senhor da Guerra* — _3 PA cada_
